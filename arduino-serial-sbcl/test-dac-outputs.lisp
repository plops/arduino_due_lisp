;; I added the two channel DAC MAX532 to an Arduino Due. This code
;; controls the femtolisp on the Arduino Due. I calibrated the
;; amplified and non-amplified DAC outputs by comparing with an
;; external Multimeter as well as the Arduino's internal ADC channels.
